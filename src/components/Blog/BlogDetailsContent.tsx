                  ...
                  <div className="entry-meta">
                    <ul>
                      <li>
                        ...
                        <Link href="#">September 31, 2023</Link>
                      </li>
                      <li>
                  ...
                  <div className="row">
                    <div className="col-md-6">
                      <ul className="features-list">
                        ...
                        <li>
                          <i className="bx bx-check-double"></i>A Career
                          Overview opportunity Available
                        </li>
                        <li>
                          <i className="bx bx-check-double"></i>A good Work
