...
const ServiceRightImageStyle: React.FC = () => {
  return (
    <>
      <div className="services-area bg-right-color ptb-100">
        <div className="container-fluid">
          <div className="row align-items-center">
            <div className="services-content">
              <div className="content left-content">
                <div className="icon">
                  <Image src="/images/icon1.png" alt="image" width={50} height={35} />
                </div>
            ...
            <div className="services-image">
              ...
              >
                <Image src="/images/services/chat.png" alt="image" width={770} height={547}  />
              </div>
            </div>
          </div>
        </div>
